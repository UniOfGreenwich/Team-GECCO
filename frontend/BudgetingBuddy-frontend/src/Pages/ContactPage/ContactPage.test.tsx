...
describe("Contact Component", () => {
  ...
  it("renders the Contact component correctly with all details", () => {
    ...
    expect(
      screen.getByText(/Email: support@budgetingbuddy.com/i),
    ).toBeInTheDocument();
    expect(screen.getByText(/Phone: \(123\) 456-7890/i)).toBeInTheDocument();
    expect(
      screen.getByText(/Address: 123 Finance Way, Suite 100/i),
    ).toBeInTheDocument();

    expect(
      screen.getByText(
        /You can also leave us a message directly on our site./i,
      ),
    ).toBeInTheDocument();
